...
Codebeispiele zum Erstellen verschiedener allgemeiner HDInsight-Clustertypen stehen zur Verfügung: [HDInsight-Python-Beispiele](https://github.com/Azure-Samples/hdinsight-python-sdk-samples).
