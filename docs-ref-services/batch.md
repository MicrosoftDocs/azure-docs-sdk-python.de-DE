...
> [Informationen zu den Client-APIs](/python/api/overview/azure/batch/clientlibrary)
...
> [!div class="nextstepaction"]
> [Informationen zu den Verwaltungs-APIs](/python/api/overview/azure/batch/managementlibrary)