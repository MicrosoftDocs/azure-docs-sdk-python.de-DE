...
ms.locfileid: "20909033"
---
# <a name="list-images"></a><span data-ttu-id="876b9-103">Auflisten von Images</span><span class="sxs-lookup"><span data-stu-id="876b9-103">List images</span></span>

<span data-ttu-id="876b9-104">Listen Sie mit dem folgenden Code alle verfügbaren Images auf, die zum Erstellen virtueller Computer verwenden werden sollen (einschließlich aller SKUs und Versionen).</span><span class="sxs-lookup"><span data-stu-id="876b9-104">Use the following code to print all of the available images to use for creating virtual machines, including all skus and versions.</span></span>
